...
singleCondition : IF_ID WHITE_SPACE* OPEN_PAR_BRACKT_ID WHITE_SPACE* var WHITE_SPACE* logicalOp WHITE_SPACE* TEXT WHITE_SPACE* CLOSE_PAR_BRACKT_ID;
doubleCondition: IF_ID WHITE_SPACE* OPEN_PAR_BRACKT_ID WHITE_SPACE* var WHITE_SPACE* logicalOp WHITE_SPACE* TEXT WHITE_SPACE* logicalOp WHITE_SPACE* var WHITE_SPACE* logicalOp WHITE_SPACE* TEXT WHITE_SPACE* CLOSE_PAR_BRACKT_ID;

var: VAR_NAME_ID;
logicalOp: AND_OP_ID|OR_OP_ID|EQUAL_OP_ID;
action: PRINT_ACTION WHITE_SPACE* TEXT+;
