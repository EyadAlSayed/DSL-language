...
public interface DSLParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DSLParser#textAttribute}.
	 * @param ctx the parse tree
	 */
	void enterTextAttribute(DSLParser.TextAttributeContext ctx);
	/**
	 * Exit a parse tree produced by {@link DSLParser#textAttribute}.
	 * @param ctx the parse tree
	 */
	void exitTextAttribute(DSLParser.TextAttributeContext ctx);
	/**
