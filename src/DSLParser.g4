...
text : TEXT_DEF_ID WHITE_SPACE* OPEN_PAR_BRACKT_ID WHITE_SPACE* FILE_NAME_ID WHITE_SPACE* (COMMA WHITE_SPACE* TEXT)? WHITE_SPACE* CLOSE_PAR_BRACKT_ID;
radioGroup: space RADIO_GROUP_ID WHITE_SPACE* OPEN_PAR_BRACKT_ID WHITE_SPACE* FILE_NAME_ID WHITE_SPACE* COMMA WHITE_SPACE* OPEN_SQR_BRACKT_ID WHITE_SPACE*  ( WHITE_SPACE* (FILE_NAME_ID | TEXTNUM) WHITE_SPACE* COMMA WHITE_SPACE*)*  WHITE_SPACE* (FILE_NAME_ID | TEXTNUM) WHITE_SPACE* CLOSE_SQR_BRACKT_ID WHITE_SPACE*  (COMMA WHITE_SPACE* radioDefault )? WHITE_SPACE* CLOSE_PAR_BRACKT_ID;
...
dropDown:space DROPDOWN WHITE_SPACE*
                       ...
                       WHITE_SPACE* CLOSE_PAR_BRACKT_ID;
button : space BUTTON_ID WHITE_SPACE* OPEN_PAR_BRACKT_ID WHITE_SPACE* FILE_NAME_ID WHITE_SPACE* (COMMA TEXT)? CLOSE_PAR_BRACKT_ID;
...
image : IMAGE WHITE_SPACE* OPEN_PAR_BRACKT_ID WHITE_SPACE* TEXT WHITE_SPACE* CLOSE_PAR_BRACKT_ID;
...
simpleMathEquation : (textValue|FILE_NAME_ID) WHITE_SPACE* mathOperation WHITE_SPACE* (textValue|FILE_NAME_ID) WHITE_SPACE*;
complexMathEquation :  mathOperation WHITE_SPACE* (textValue|FILE_NAME_ID) WHITE_SPACE* mathOperation WHITE_SPACE* (textValue|FILE_NAME_ID) WHITE_SPACE* ;
...
//main_condition: (condition|(condition WHITE_SPACE* binary_condition+)) | (equal_condition|(equal_condition WHITE_SPACE* binary_equal_condition+));
