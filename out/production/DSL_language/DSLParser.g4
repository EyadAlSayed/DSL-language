...
checkbox: CHECKBOX OPEN_PAR_BRACKT_ID WHITE_SPACE* FILE_NAME_ID WHITE_SPACE* COMMA WHITE_SPACE* OPEN_SQR_BRACKT_ID (WHITE_SPACE* (FILE_NAME_ID | TEXTNUM) WHITE_SPACE*)? (COMMA WHITE_SPACE* (FILE_NAME_ID | TEXTNUM) WHITE_SPACE*)* CLOSE_SQR_BRACKT_ID WHITE_SPACE* marginList CLOSE_PAR_BRACKT_ID;
dropDown:space DROPDOWN WHITE_SPACE*
                       ...
                       WHITE_SPACE* marginList CLOSE_PAR_BRACKT_ID;
...
textField: TEXT_FIELD OPEN_PAR_BRACKT_ID FILE_NAME_ID WHITE_SPACE* (COMMA WHITE_SPACE* TEXT)? (COMMA WHITE_SPACE* textFieldAttribute)? WHITE_SPACE* marginList CLOSE_PAR_BRACKT_ID;
controllerTokens:
          ifStatment
          |loop
          |print
